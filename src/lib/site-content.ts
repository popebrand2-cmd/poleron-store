...
export const SITE_TEXT_DEFAULTS: Record<string, string> = {
  ...
  "collections.subtext": "Elige un artista, explora su catálogo de diseños y frases y estámpalo directo en tu prenda.",
  "faq.eyebrow": "Dudas",
  ...
  "browse.tees": "Poleras",
  "collections.cta": "Ver diseños",
  "artist.back": "Volver a colecciones",
  "artist.eyebrow": "POPE · Colección artista",
  "artist.cta": "Crear con este artista",
  ...
  // Videos that ship with the site (files in /media). The owner can change or remove any of them
  // from the edit panel; that saved choice always wins over these defaults.
  ...
  "videos.all": "Todos",
  "video.1.src": "/uploads/pope-video-1.mp4",
  "video.1.tag": "",
  "video.1.caption": "Trabajo 1",
  "video.2.src": "/uploads/pope-video-2.mp4",
  "video.2.tag": "",
  "video.2.caption": "Trabajo 2",
  "video.3.src": "/uploads/pope-video-3.mp4",
  "video.3.tag": "",
  "video.3.caption": "Trabajo 3",
  "video.4.src": "/uploads/pope-video-4.mp4",
  "video.4.tag": "",
  "video.4.caption": "Trabajo 4",
  "video.5.src": "/uploads/pope-video-5.mp4",
  "video.5.tag": "",
  "video.5.caption": "Trabajo 5",
  "video.6.src": "/uploads/pope-video-6.mp4",
  "video.6.tag": "",
  "video.6.caption": "Trabajo 6",
  "video.7.src": "/uploads/pope-video-7.mp4",
  "video.7.tag": "",
  "video.7.caption": "Trabajo 7",
  "video.8.src": "",
  "video.8.tag": "",
  "video.8.caption": "",
